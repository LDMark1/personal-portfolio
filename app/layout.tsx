...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      {/* v0 – built-with badge */}
  <div dangerouslySetInnerHTML={{ __html: `<div id="v0-built-with-button-59bbb0dc-889c-442c-9fc0-632c6a6c581d" style="
...
">
<a
  href="https://v0.dev/chat/api/open/built-with-v0/b_yZF40o6BpVT"
  target="_blank"
...
<button
  onclick="document.getElementById('v0-built-with-button-59bbb0dc-889c-442c-9fc0-632c6a6c581d').style.display='none'"
